...
`version unverified`. The cards below reflect the current `VERSION` value `0.2.5`; they do not
hard-code the workflow generation.

```text
   ()_()
 ( ◕ᴥ◕ )
   ╰ ^ ╯ · CER Workflow v0.2.5 · 🔵 CER started
```
...
```text
   ()_()
 ( ᴗᴥᴗ )
   ╰ ^ ╯ · CER Workflow v0.2.5 · ⚪ CER stopped · CER inactive
```
...
```text
   ()_()
 ( ᴗᴥᴗ )
   ╰ ^ ╯ · CER Workflow v0.2.5 · 🟢 CER closed · writer closed
```
...
```text
   ()_()
 ( ◕ᴥ◕ )
   ╰ ^ ╯ · CER Workflow v0.2.5 · 🔴 Major blocker · checkpoint blocked
```
